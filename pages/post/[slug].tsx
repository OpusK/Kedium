      ...
      <article className="max-w-3xl mx-auto p-5">
        ...
        <div className="mt-10">
          <PortableText
            ...
            content={post.body}
            serializers={{
              h1: (props: any) => <h1 {...props} className="text-2xl font-bold my-5" {...props} />,
              h2: (props: any) => <h2 {...props} className="text-xl font-bold my-5" {...props} />,
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col p-5 max-w-2xl mx-auto mb-10">
          ...
          <label className="block mb-5">
            ...
            <textarea
              ...
              className="shadow border rouded py-2 px-3 form-textarea mt-1 block w-full ring-yellow-500 outline-none focus:ring"
              placeholder="John Appleaseed"
              rows={8}
            />
          </label>                        
